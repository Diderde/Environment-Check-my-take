...
echo [████□□□□□□□□□□□□□□□□] 20%% Moving bricks......
ping -n 1 -w 450 192.0.2.1 >nul
echo [██████□□□□□□□□□□□□□□] 30%% Enbugging......
ping -n 1 -w 450 192.0.2.1 >nul
echo [████████□□□□□□□□□□□□] 40%% Caveman Debugging......
ping -n 1 -w 450 192.0.2.1 >nul
echo [██████████□□□□□□□□□□] 50%% Breading crumbs......
ping -n 1 -w 450 192.0.2.1 >nul
echo [████████████□□□□□□□□] 60%% Rubber Duck Debugging......
ping -n 1 -w 450 192.0.2.1 >nul
echo [██████████████□□□□□□] 70%% Bribing the hamster......
ping -n 1 -w 450 192.0.2.1 >nul
echo [████████████████□□□□] 80%% Whatchamacalliting......
ping -n 1 -w 450 192.0.2.1 >nul
echo [██████████████████□□] 90%% Flibbertigibbrting......
ping -n 1 -w 450 192.0.2.1 >nul
